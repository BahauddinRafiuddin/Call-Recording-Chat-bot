...
const ChatWorkspace = ({ onMenuClick }) => {
  ...
  const [messages, setMessages] = useState([
    { role: "ai", text: "Hi! Ask me anything about your call recordings. Select a specific call above or query across all of them." }
  ]);
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-gray-50 overflow-hidden">
      ...
      <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-100">
        ...
        <span className="text-sm font-medium text-gray-700">AI Call Assistant</span>
      </div>
